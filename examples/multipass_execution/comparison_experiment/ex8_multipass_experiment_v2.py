...
# main_folders = [f"results_Lcr/results_Lcr_20mm/pump_power_passes_{i+1}/pump_power" for i in range(n_passes)]
...
plt.tight_layout()
fig.savefig("efficiency_distance.png", dpi=150, bbox_inches='tight')
plt.show()
